...
public class DoctorController {
    ...
    public ResponseEntity<ApiResult<PagedModel<DoctorResponse>>> getDoctors(
            @PageableDefault(size = 20, sort = "doctorId", direction = Sort.Direction.ASC) Pageable pageable) {
